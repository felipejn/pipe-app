...
- **Modelo:** `inclusionai/ling-3.0-flash-fin:free` (1.11T tokens, 262K ctx) — configurado via `OPENROUTER_MODEL` env var. Fallbacks: `nex-agi/nex-n2.5-mini:free`, `inclusionai/ling-3.0-flash-sante:free`, `liquid/lfm2.5-2.6b:free`, `nvidia/nemotron-3-super-120b-a12b:free`, `nvidia/nemotron-3-ultra-550b-a55b:free`
