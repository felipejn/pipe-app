...
SYSTEM_PROMPT_LEITURA = (
    ...
    '  conversões de moeda e resumo geral do utilizador\n'
...
SYSTEM_PROMPT_ESCRITA = (
    ...
    'Respostas devem ser em português europeu (pt-PT).\n\n'
    'CAPACIDADES\n'
    '- Podes consultar câmbios/conversões de moeda, além de consultar E EXECUTAR\n'
    '  ACÇÕES nos módulos Tarefas, Notas, Calendário e Passwords.\n'
