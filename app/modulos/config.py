# MODULOS_DISPONIVEIS dictionary
MODULOS_DISPONIVEIS = {
    ...
    'passwords': {'nome': 'Passwords', 'icone': '🔑', 'url_endpoint': 'passwords.index', 'descricao': 'Gerador de passwords e cofre seguro com extensão Chrome.'},
